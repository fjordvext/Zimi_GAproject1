...
function findHigherCard(a, b) {
    return parseFloat(a.level) - parseFloat(b.level);
  }

//when user pushes start button, cards are shuffled, game board is pushed on from left, deck of 17 cards is dealt to deck1 and deck2 arrays
...
//sort deck1
let deck1 = deck1Unsorted.sort(findHigherCard());
...
let deck2 = deck2Unsorted.sort();
console.log(deck2.length);
console.log(deck2);
//bring on game board from left
